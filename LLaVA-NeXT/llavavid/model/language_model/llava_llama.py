...
class LlavaConfig(LlamaConfig):
    ...
    def __init__(self, **kwargs):
        # add missing HF fields with safe defaults
        kwargs.setdefault("mlp_bias", False)         # HF llama expects this in some versions
        kwargs.setdefault("attention_bias", False)   # optional but often helpful
